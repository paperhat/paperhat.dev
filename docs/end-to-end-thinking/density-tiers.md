...
3. **A concrete compiler phase breakdown (TSX → IR → RDF → back)**
...
Every node in your TSX AST must be classified as **exactly one** of:
...
## 1.2 How this looks in TSX (explicit but unobtrusive)
...
You are not “parsing TSX”.
You are compiling **claims**.

---

## 3.1 Phase 1 — TSX Parsing (syntax only)
